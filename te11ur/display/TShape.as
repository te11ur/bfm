package te11ur.display
{
	...
	public class TShape extends Shape implements TGraphic
	{		
		...
		{
			if(!visible || (fillWidth == width && fillHeight == height && fillColor == _fillColor && fillAlpha == _fillAlpha && fillBorder == _fillBorder && fillBorderColor == _fillBorderColor)) {
				return;
			}
			
			trace('TShape '+fillWidth+' '+width+' '+fillHeight+' '+height+' '+fillAlpha+' '+fillAlpha);
